...
//windspeed
volatile uint8_t flag_wspeed = 0;
volatile uint32_t Nb_Pulse = 0;
float speed = 0.0;
...
static void MX_GPIO_Init(void)
{
	...
	/*Configure GPIO pin : WINDSPEED_Pin */
	GPIO_InitStruct.Pin = WINDSPEED_Pin;
	GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
	GPIO_InitStruct.Pull = GPIO_NOPULL;
	HAL_GPIO_Init(WINDSPEED_GPIO_Port, &GPIO_InitStruct);
